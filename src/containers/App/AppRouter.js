    ...
    return (
      <Switch>
        ...
        <Route
          exact
          path={`${url}/tmap`}
          component={asyncComponent(() => import('../tMap'))}
        />
        <Route
          exact
          path={`${url}/collapsible`}
          component={asyncComponent(() => import('../Collapsible'))}
        />
        <Route
          exact
          path={`${url}/hos`}
          component={asyncComponent(() => import('../hos'))}
        />
        <Route
          exact
          path={`${url}/logdata`}
          component={asyncComponent(() => import('../logdata'))}
        />
        <Route
          exact
          path={`${url}/calendar`}

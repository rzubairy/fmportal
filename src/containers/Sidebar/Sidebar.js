...
import drivericon from '../../image/truckdrivericonwht.svg';
import truckfronticon from '../../image/truck_front_icon_wht.svg';
      ...
      <SidebarWrapper>
        ...
        >
          ...
          >
            ...
            >
              <span className="menuheaders" style={submenuColor}>
                {/* <i className="ion-person" /> */}
                  <img className="drivericon" src={drivericon} alt="Driver Icon" />
                  <span className="section-text">
                    <IntlMessages id="Drivers" />
                </span>
              </span>
              ...
              <Menu.Item key="logdata">
                <Link to={`${url}/logdata`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-clipboard" />
                    <span className="nav-text">
                      <IntlMessages id="Log Data" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              ...
              <Menu.Item key="tmap">
                <Link to={`${url}/tMap`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-map" />
                    <span className="nav-text">
                      <IntlMessages id="Tim Maps" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>

              {/* <Menu.Item key="collapsible">
                <Link to={`${url}/Collapsible`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-map" />
                    <span className="nav-text">
                      <IntlMessages id="Collapsible" />
                    </span>
                  </span>
                </Link>
              </Menu.Item> */}
              ...
              <SubMenu
                ...
                title={
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-bag" />
                    <span className="nav-text">
                      <IntlMessages id="Tools" />
                    </span>
                  </span>
                }
              >
                <Menu.Item style={submenuStyle} key="mailbox">
                  <Link style={submenuColor} to={`${url}/mailbox`}>
                    <span className="isoMenuHolder" style={submenuColor}>
              ...
              <Menu.Item style={submenuStyle} key="table_fb">
                <Link style={submenuColor} to={`${url}/table_fb`}>
                  <IntlMessages id="FB Tables" />
                </Link>
              </Menu.Item>
              </SubMenu>
